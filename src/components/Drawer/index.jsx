...
export default class Drawer extends React.Component {
    ...
    openModal() {
        const { mode, visible, animationDuration, height = 0, width = 0 } = this.props;
        // 有动画
        if (mode === 'Left') { // 左滑
    ...
    render() {
        const { title, width, height, mode, hasBottomClose, children } = this.props;
        const { positionL, positionR, positionD, positionT, opacity } = this.state;
