...
var ButtonCustom = /** @class */ (function (_super) {
    ...
    ButtonCustom.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_native_1.TouchableHighlight, { underlayColor: index_style_1.default[type + "Wrap"].backgroundColor, style: [index_style_1.default.commonWrap, index_style_1.default[type + "Wrap"], disabled ? index_style_1.default.disabled : {}], onPress: this.onPress },
